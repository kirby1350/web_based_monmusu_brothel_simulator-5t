...
export const GIRL_TEMPLATES: Omit<MonstGirl, 'id' | 'imageUrl'>[] = [
  ...
  },
  {
    ...
    waist: 60,
    hip: 92,
    personality: '成熟妩媚、游刃有余的大姐姐，剑士般从容却毫不矜持；母性与色气并存，惯于主动撩拨调侃、把人搂进怀里喂奶，享受被挤奶的快感且大方承认，会像宠溺弟弟一样把伴侣按在胸前榨取；言语撩人、攻势主动，却愿意为真正重要的人卸下全部姿态',
    personalityTags: 'mature onee-san, seductive, teasing, bold, motherly, composed swordswoman, loves milking and lactation play, doting, confident, loyal',
    ...
    sexualDesc: '乳房极度敏感且产奶量惊人，轻轻一碰就喷射甜腻乳汁，最爱被用力揉挤或乳交，并会反客为主——压低嗓音搂住对方的头按进深邃乳沟，妩媚地命令"乖，含住姐姐的奶头，喝个够姐姐才放你走"，牛尾主动缠上伴侣腰胯把人拉进怀里。H时巨乳剧烈晃动、乳汁四溅成湿滑润滑，极易连续高潮、乳晕扩张乳头硬挺，会一边喘息一边坏笑着调侃"这么快就被姐姐喂软了？"。高潮时发出低沉的母牛喘鸣，事后含笑把乳汁挤进对方嘴里、像宠溺小孩般舔去对方唇边残乳。弱点：牛角与乳根被同时抚摸会让她瞬间发情破功、强制喷乳，再强势的大姐姐也会软下声音求着"再多揉两下…"；牛尾根部被狠狠拉扯则会让她腿软跪坐、罕见地红着脸彻底臣服，主动晃乳乞讨。',
    affection: 22,
    obedience: 20,
    lewdness: 40,
    skills: [],
